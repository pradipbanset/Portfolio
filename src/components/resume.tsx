...
export function Resume() {
  const resumeDetails = {
    title: "Pradip's Resume",
    description: 'Data Science Student • AI/ML Practitioner',
    fileType: 'PDF',
    lastUpdated: 'March 2026',
    fileSize: '0.5 MB',
    downloadUrl: '/portfolio/public/pradip-Basnet-cv-3.pdf',
  };

  const handleDownload = () => {
    const link = document.createElement('a');
    link.href = resumeDetails.downloadUrl;
    link.download = 'resume_pradip.pdf';
